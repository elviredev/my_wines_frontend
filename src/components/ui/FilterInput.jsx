    ...
    <div>
      ...
      <div className="relative">
        ...
        <input
          ...
          className={`w-full pl-9 pr-3 py-2.5 text-sm bg-stone-950/60 border border-stone-700 rounded-xl text-stone-100 placeholder:text-stone-500 focus:outline-none focus:border-rose-500 focus:ring-0 hover:border-rose-700 transition duration-200 ${className}`}
          {...rest}
        />
      </div>
